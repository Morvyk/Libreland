...
impl X11Surface {
    ...
    /// **Libreland vendor patch** (this and [`Self::x11_unfocus`]).
    ///
    ...
    pub fn x11_take_focus(&self) -> Result<(), ConnectionError> {
        ...
        // Mirror the `KeyboardTarget::enter` impl: a deferred focus
        // release still pending would clobber the focus we set here.
